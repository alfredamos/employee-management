...
exports.checkIfAuthenticatedMiddleware = void 0;
...
exports.checkIfAuthenticatedMiddleware = checkIfAuthenticatedMiddleware;
function verifyJwtToken(authToken) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield jwt.verify(authToken, process.env.JSON_WEB_TOKEN);
    });
}
/*
